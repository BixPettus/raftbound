export const ENEMY_SPAWN_TABLES = [
  ...
  },
  {
    id: "jungle_enemies",
    implemented: true,
    budgetBySize: { small: 5, medium: 9, large: 13 },
    entries: [
      { enemyId: "vine_stalker", weight: 6, density: 1, minCount: 1, maxCountBySize: { small: 1, medium: 2, large: 3 }, allowedRegion: "jungle", minimumPlayerLevel: 3, minimumSpacingTiles: 11, safeZoneExclusionTiles: 14, requiresDryGround: true },
      { enemyId: "shore_crawler", weight: 1, density: 0.28, minCount: 0, maxCountBySize: { small: 0, medium: 1, large: 1 }, allowedRegion: "shore", minimumPlayerLevel: 1, minimumSpacingTiles: 12, safeZoneExclusionTiles: 14 }
    ]
  },
